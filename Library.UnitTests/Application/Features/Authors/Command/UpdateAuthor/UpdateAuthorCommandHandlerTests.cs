...
namespace Library.UnitTests.Application.Features.Authors.Command.UpdateAuthor
{
    public class UpdateAuthorCommandHandlerTests
    {
        private readonly UpdateAuthorCommandHandler _sut;
        ...
        public UpdateAuthorCommandHandlerTests()
        {
            ...
            _sut = new UpdateAuthorCommandHandler(_authorRepositoryMock.Object, _unitOfWorkMock.Object);
        }

        [Fact]
        public async Task Handler_Should_UpdateAnAuthor()
        {
            //Arrange
            ...
            //Assert
            _authorRepositoryMock.Verify(x => x.UpdateAuthorSync(It.IsAny<Author>()), Times.Once);
        ...
        public async Task Handler_Should_ThrowAnExceptionIfAuthorIsNotFound()
        {
            ...
            //Assert
            await Assert.ThrowsAsync<NotFoundException>(() => _sut.Handle(new UpdateAuthorCommand(), It.IsAny<CancellationToken>()));
